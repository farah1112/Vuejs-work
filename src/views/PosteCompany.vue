...
<v-col>
        ...
        >
          ...
          <br><br>
           ...
           <p class="font-weight-bold">
             ...
             <v-btn outlined fab flat rounded prepend-icon="mdi-email-open-outline" title="Nous contacter" value="Nous contacter" to="/ContactCompany">
             Nous contacter!
            </v-btn>
            <br>
        </v-list>
    ...
    <v-col cols="12" md="8">
      <h5 class="font-weight-bold">Publier vos Postes</h5>
        ...
        <p>Lieu de Travail</p>
          <v-text-field
            label="Ville région ou département"
            placeholder="Placeholder"
            variant="outlined"
        ...
        <p>Temps du travail</p>
          <v-text-field
            label="Temps-partiel,Temps-plein"
            placeholder="Placeholder"
            variant="outlined"
        ...
        <p>Choisissez la période</p>
          <v-text-field
            label="Par mois,ans,semaine ou jour!"
            placeholder="Placeholder"
            variant="outlined"
             prepend-inner-icon="mdi-flag-variant-outline"
          ></v-text-field>
      ...
      v-model="people"
      color="green"
      label="Ignorer cette section"
      value="Ignorer cette section"
      hide-details
    ></v-switch>
           </v-col>
         </v-row>
